...
export const UPDATE_USERS_REQUEST = `${{ DEFAULT_PATH }}/UPDATE_USERS_REQUEST`;
export const UPDATE_USERS_SUCCESS = `${{ DEFAULT_PATH }}/UPDATE_USERS_SUCCESS`;
export const UPDATE_USERS_ERROR = `${{ DEFAULT_PATH }}/UPDATE_USERS_ERROR`;
